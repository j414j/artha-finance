...
- [x] Phase 5 — complete
- [x] Phase 6 — complete
- [x] Phase 7 — complete (Dashboard built using existing APIs directly; no dedicated /api/v1/dashboard/* endpoints)
- [~] Phase 8 — partially complete
  - [x] CashFlowReport — fully implemented (Sankey via d3-sankey, bar charts, period selector)
